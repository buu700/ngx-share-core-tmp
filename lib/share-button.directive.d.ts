import { OnChanges, OnDestroy, OnInit, SimpleChanges, EventEmitter, ElementRef, Renderer2, ChangeDetectorRef } from '@angular/core';
import { HttpClient } from '@angular/common/http';
import { Meta } from '@angular/platform-browser';
import { Platform } from '@angular/cdk/platform';
import { ShareService } from './share.service';
import { ShareButtonBase } from './buttons';
export declare class ShareDirective implements OnChanges, OnDestroy, OnInit {
    private _meta;
    private _el;
    private _http;
    private _platform;
    ...
    /** Share the link */
    share(): void;
    init(changes?: SimpleChanges): void;
